...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { state_led[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { state_led[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
