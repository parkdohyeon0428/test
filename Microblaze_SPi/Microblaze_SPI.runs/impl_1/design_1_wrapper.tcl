...
namespace eval ::optrace {
  variable script "D:/test/Microblaze_SPi/Microblaze_SPI.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/test/Microblaze_SPi/Microblaze_SPI.runs/synth_1/design_1_wrapper.dcp
