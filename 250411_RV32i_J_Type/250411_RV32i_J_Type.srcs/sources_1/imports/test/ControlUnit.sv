...
module ControlUnit (
    ...
    always_comb begin
        signals = 9'b0;
        case (opcode)
            // {regFileWe, aluSrcMuxSel, dataWe, [2:0]RFWDSrcMuxSel, branch, jal, jalr} = signals
            ...
            `OP_TYPE_LU: signals = 9'b1_0_0_010_1_0_0;
            `OP_TYPE_AU: signals = 9'b1_0_0_011_1_0_0;
            `OP_TYPE_J:  signals = 9'b1_1_0_100_0_1_0;
