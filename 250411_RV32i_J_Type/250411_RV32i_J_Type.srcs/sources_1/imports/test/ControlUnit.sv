...
module ControlUnit (
    ...
    logic [9:0] signals;
    assign {regFileWe, aluSrcMuxSel, dataWe, RFWDSrcMuxSel, branch, LUSrcMuxSel, JSrcMuxSel, PCSrcMuxSel} = signals;

    always_comb begin
        signals = 10'b0;
        case (opcode)
            // {regFileWe, aluSrcMuxSel, dataWe, [2:0]RFWDSrcMuxSel, branch, *LUSrcMuxSel, JSrcMuxSel, PCSrcMuxSel} = signals
            ...
            `OP_TYPE_LU: signals = 10'b1_0_0_010_1_1_0_0;
            `OP_TYPE_AU: signals = 10'b1_0_0_011_1_1_0_0;
            `OP_TYPE_J:  signals = 10'b1_1_0_100_0_0_1_0;
