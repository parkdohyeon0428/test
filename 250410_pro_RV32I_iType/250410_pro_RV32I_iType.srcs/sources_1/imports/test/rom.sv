...
module rom (
    ...
    initial begin
        //rom[x]=32'b fucn7 _ rs2 _ rs1 _f3 _ rd  _opcode; // R-Type
          ...
          rom[1] = 32'b0100000_00110_00001_000_00101_0110011; // sub x5, x2, x1
        ...
        //rom[x]=32'b imm12      _rs1  _f3 _ rd  _ opcode;
          rom[4] = 32'b000000001000_00010_000_00110_0010011; // addi x6, x2, 8;
        //rom[x]=32'b imm7  _ rs2 _ rs1 _f3 _ imm5_ opcode;
          rom[5] = 32'b0000000_00111_00111_001_01000_1100011;
          rom[6] = 32'b0000000_00011_00101_110_01000_1100011;
          rom[8] = 32'b0000000_00111_00011_111_01000_1100011;
