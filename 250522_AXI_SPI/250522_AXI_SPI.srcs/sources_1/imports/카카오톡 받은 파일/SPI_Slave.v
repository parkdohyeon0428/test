...
module SPI_Slave_Intf (
    ...
    localparam SO_IDLE = 0, SO_PHASE = 1, SO_DELAY = 2, SO_DELAY1 = 3;
...
module SPI_Slave_Reg (
    ...
    localparam IDLE = 0, ADDR_PHASE = 1, WRITE_PHASE = 2, READ_PHASE = 4, READ_DELAY_PHASE=3;
    ...
    reg prev_SCLK;
    reg r_done_next, r_done_reg;
    reg a_done_next, a_done_reg;
    
    assign r_done = r_done_reg;
    assign a_done = a_done_reg;
    reg prev_so_done;
    ...
    always @(*) begin
        ...
        case (state)
            ...
            WRITE_PHASE: begin  // write operation 2
                 a_done_next = 1;
                if (!ss_n) begin
                    if (si_done) begin
                        case (addr_reg)
