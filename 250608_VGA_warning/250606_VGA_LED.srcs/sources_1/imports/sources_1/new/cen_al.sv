...
module census_matcher_top (
    ...
    always_comb begin
        if (!de)
            q_gray = 6'd0;
        else if (rgb < 8'd16)     q_gray = 6'd0;
        else if (rgb < 8'd26)     q_gray = 6'd1;
        else if (rgb < 8'd39)     q_gray = 6'd2;
        else if (rgb < 8'd52)     q_gray = 6'd3;
        else if (rgb < 8'd65)     q_gray = 6'd4;
        else if (rgb < 8'd78)     q_gray = 6'd5;
        else if (rgb < 8'd91)     q_gray = 6'd6;
        else if (rgb < 8'd104)    q_gray = 6'd7;
        else if (rgb < 8'd117)    q_gray = 6'd8;
        else if (rgb < 8'd130)    q_gray = 6'd9;
        else if (rgb < 8'd143)    q_gray = 6'd10;
        else if (rgb < 8'd156)    q_gray = 6'd11;
        else if (rgb < 8'd169)    q_gray = 6'd12;
        else if (rgb < 8'd182)    q_gray = 6'd13;
        else if (rgb < 8'd195)    q_gray = 6'd14;
        else if (rgb < 8'd208)    q_gray = 6'd15;
        else if (rgb < 8'd221)    q_gray = 6'd16;
        else if (rgb < 8'd234)    q_gray = 6'd17;
        else if (rgb < 8'd247)    q_gray = 6'd18;
        else                      q_gray = 6'd19;
    end
