...
module top_stopwatch(
    ...
    wire w_run, w_clear, w_hour, w_min, w_sec, run, clear;
    ...
    top_stopwatch_mux U_Stopwatch_Mux (
    .clk(clk),
    .reset(reset),
...
module top_stopwatch_mux (
    input clk, reset,
    input [6:0] watch_msec, stopwatch_msec,
    input [5:0] watch_sec, stopwatch_sec,
    input [5:0] watch_min, stopwatch_min,
    input [4:0] watch_hour, stopwatch_hour,
    input [1:0] sw_mode,
